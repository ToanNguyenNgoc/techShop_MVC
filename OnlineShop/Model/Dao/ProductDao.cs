...
namespace Model.Dao
{
    public class ProductDao
    {
        ...
        public List<Product> ListByCategoryId(long categoryId,ref int totalRecord , int page=1, int pageSize=10)
        {
        ...
        public List<Product> ListRecommenProduct(long productId)
        {
